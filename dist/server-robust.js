    ...
    registerTools() {
        ...
        this.server.registerTool('plan_project', {
            ...
            inputSchema: {
                ...
                requestSDD: zod_1.z.boolean().optional().describe('Generate SDD documents if true'),
                requestTests: zod_1.z.boolean().optional().describe('Generate test specifications if true'),
                userApproval: zod_1.z.enum(['yes', 'no', 'approved', 'proceed']).optional().describe('Explicit user approval for SDD generation'),
            },
        }, async (params) => {
...
//# sourceMappingURL=server-robust.js.map