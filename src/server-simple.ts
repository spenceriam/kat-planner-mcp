  ...
  private registerTools(): void {
    ...
    this.server.registerTool('plan_project', {
      ...
      inputSchema: {
        ...
        generateSDD: z.boolean().optional().describe('Generate SDD documents if true'),
        generateTests: z.boolean().optional().describe('Generate test specifications if true'),
      },
    }, async (params: { userIdea: string; userAnswers?: Record<string, string>; generateSDD?: boolean; generateTests?: boolean }) => {
